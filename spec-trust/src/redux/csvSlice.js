...
export const createZip = () => async (dispatch, getState) => {
    try {
        ...
        const resultsContent = generateMethodResults(csv.sd.mean, csv.sd.uncertainty, csv.inverseSigma.mean, csv.inverseSigma.uncertainty, csv.mc.mean, csv.mc.uncertainty, csv.shapiro.static, csv.shapiro.p)
